...
public:
    /* 实习服务员，一次只能搞一个便签 */
    TraineeWaiter(Command* pCommand)
        : m_pcommand(pCommand)
    {
    }
...
private:
    Command* m_pcommand; /* 实习服务员手中我这顾客书写的菜品的便签 */
};
...
int main(void)
{
    ...
    TraineeWaiter* pwaiter1 = new TraineeWaiter(new CommandFish(new Cook));
